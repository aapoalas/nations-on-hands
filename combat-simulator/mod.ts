...
> = {
  "1-1": { casualty: [0, 0, 0, 0, 0, 0, 0.05, 0.05], morale: [0, 0, 0, 0, 0.2, 0.4, 0.6, 0.8], },
  "1-2": { casualty: [0, 0, 0, 0, 0.05, 0.05, 0.05, 0.1], morale: [0, 0, 0.2, 0.5, 0.8, 1.1, 1.5, 1.9], },
  "1-3": { casualty: [0, 0, 0, 0.05, 0.05, 0.05, 0.1, 0.1], morale: [0, 0.3, 0.6, 0.9, 1.3, 1.8, 2.3, 2.8], },
  "1-4": { casualty: [0, 0, 0.05, 0.05, 0.05, 0.1, 0.1, 0.1], morale: [0.4, 0.6, 0.9, 1.3, 1.8, 2.4, 3.0, 3.6], },
  "1-5": { casualty: [0, 0.05, 0.05, 0.05, 0.05, 0.1, 0.1, 0.15], morale: [0.9, 1.1, 1.4, 1.8, 2.3, 2.9, 3.5, 4.1], },
  "2-1": { casualty: [0, 0, 0, 0.05, 0.05, 0.05, 0.1, 0.1], morale: [0, 0, 0, 0.2, 0.5, 0.8, 1.1, 1.4], },
  "2-2": { casualty: [0, 0, 0.05, 0.05, 0.05, 0.1, 0.1, 0.1], morale: [0, 0.2, 0.4, 0.7, 1.0, 1.4, 1.9, 2.4], },
  "2-3": { casualty: [0, 0, 0.05, 0.05, 0.1, 0.1, 0.1, 0.15], morale: [0.3, 0.5, 0.8, 1.1, 1.5, 2.0, 2.6, 3.2], },
  "2-4": { casualty: [0, 0.05, 0.05, 0.05, 0.1, 0.1, 0.15, 0.15], morale: [0.6, 0.9, 1.2, 1.6, 2.1, 2.6, 3.2, 3.8], },
  "2-5": { casualty: [0.05, 0.05, 0.05, 0.1, 0.1, 0.1, 0.15, 0.15], morale: [1.1, 1.4, 1.7, 2.1, 2.6, 3.1, 3.7, 4.3], },
  "3-1": { casualty: [0, 0, 0.05, 0.05, 0.1, 0.1, 0.1, 0.15], morale: [0, 0, 0.2, 0.5, 0.8, 1.1, 1.5, 1.9], },
  "3-2": { casualty: [0, 0.05, 0.05, 0.05, 0.1, 0.1, 0.15, 0.15], morale: [0.1, 0.3, 0.6, 1.0, 1.4, 1.8, 2.2, 2.6], },
  "3-3": { casualty: [0, 0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.15], morale: [0.5, 0.8, 1.1, 1.4, 1.8, 2.3, 2.8, 3.3], },
  "3-4": { casualty: [0.05, 0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.2], morale: [0.9, 1.1, 1.4, 1.8, 2.3, 2.9, 3.5, 4.1], },
  "3-5": { casualty: [0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.15, 0.2], morale: [1.4, 1.6, 1.9, 2.3, 2.8, 3.4, 4.0, 4.6], },
  "4-1": { casualty: [0, 0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.15], morale: [0, 0.2, 0.4, 0.7, 1.0, 1.4, 1.9, 2.4], },
  "4-2": { casualty: [0, 0.05, 0.05, 0.1, 0.15, 0.15, 0.15, 0.2], morale: [0.4, 0.7, 1.0, 1.3, 1.6, 1.9, 2.3, 2.8], },
  "4-3": { casualty: [0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.15, 0.2], morale: [0.8, 1.0, 1.3, 1.6, 2.0, 2.5, 3.1, 3.7], },
  "4-4": { casualty: [0.05, 0.1, 0.1, 0.1, 0.15, 0.15, 0.2, 0.2], morale: [1.1, 1.4, 1.7, 2.1, 2.6, 3.1, 3.7, 4.3], },
  "4-5": { casualty: [0.05, 0.1, 0.1, 0.15, 0.15, 0.2, 0.2, 0.2], morale: [1.6, 1.9, 2.2, 2.6, 3.1, 3.6, 4.2, 4.8], },
  "5-1": { casualty: [0.05, 0.05, 0.1, 0.1, 0.15, 0.15, 0.15, 0.2], morale: [0.1, 0.3, 0.6, 1.0, 1.4, 1.8, 2.2, 2.6], },
  "5-2": { casualty: [0.05, 0.1, 0.1, 0.1, 0.15, 0.15, 0.2, 0.2], morale: [0.5, 0.8, 1.1, 1.4, 1.8, 2.3, 2.8, 3.3], },
  "5-3": { casualty: [0.05, 0.1, 0.1, 0.15, 0.15, 0.2, 0.2, 0.2], morale: [0.9, 1.1, 1.4, 1.8, 2.3, 2.9, 3.5, 4.1], },
  "5-4": { casualty: [0.05, 0.1, 0.15, 0.15, 0.15, 0.2, 0.2, 0.25], morale: [1.3, 1.6, 2.0, 2.4, 2.9, 3.4, 3.9, 4.5], },
  "5-5": { casualty: [0.05, 0.1, 0.15, 0.15, 0.2, 0.2, 0.25, 0.25], morale: [1.8, 2.1, 2.5, 2.9, 3.4, 3.9, 4.4, 5.0], },
} as const;
